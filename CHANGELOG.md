...
- Add `network.giantswarm.io/wildcard-cname-target` annotation to override the wildcard CNAME target for workload clusters.
...
- Add `machine-deployment.giantswarm.io/name` annotation.
...
[Unreleased]: https://github.com/giantswarm/k8smetadata/compare/v0.26.0...HEAD
[0.26.0]: https://github.com/giantswarm/k8smetadata/compare/v0.25.0...v0.26.0
[0.25.0]: https://github.com/giantswarm/k8smetadata/compare/v0.24.0...v0.25.0
[0.24.0]: https://github.com/giantswarm/k8smetadata/compare/v0.23.0...v0.24.0
[0.23.0]: https://github.com/giantswarm/k8smetadata/compare/v0.23.0...v0.23.0
